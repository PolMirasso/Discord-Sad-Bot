module.exports = {
    ayuda: `Te lo explica gru.`,
    ejemplo: "gru Estudiar 2 semanas antes, Aprobar el examen, Suspender por no poner el nombre",
    permiso : "Ninguno",
...
let img = await weez.gru(texto1 , texto2 , texto3);
